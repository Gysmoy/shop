(function (e) {
    ...
    function A(t, n, i) {
        typeof i == "string" && (
            ...
            this.container.hide(), this.run(n)
    }
    var t = [].indexOf || function (e) {
        ...
        m = function (t, i) {
            ...
            var o = "";
            i.classes && e.each(
                i.classes, function (t, n) {
                    return o += "." + r + "-" + i.name + "-" + t + " {\n",
                        e.each(n, function (t, n) {
                            return p[t] && e.each(p[t],
                                function (e, r) {
                                    return o += "	" + r + t + ": " + n + ";\n"
                                }
                            ),
        ...
        N = function (t) {
            ...
            return t.is("[type=radio]") && (
                n = t.parents("form:first").find("[type=radio]").filter(function (n, r) {
    ...
    A.prototype.loadHTML = function () {
        ...
        A.prototype.show = function (e, t) {
            ...
            else if (!o && e) s = this.options.showAnimation,
        ...
        A.prototype.setElementPosition = function () {
            ...
            for (w = 0, S = B.length; w < S; w++)
                D = B[w], N = parseInt(this.elem.css("margin-" + D), 10),
                    N && C(p, D, N);
