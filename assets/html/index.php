...
<html lang="es">
    ...
    <body>
                    ...
                    <div class="navbar-nav ml-auto">
                        ...
                        <!--div class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu">
                                <a href="blog.html" class="dropdown-item">Área de administración</a>
                                <a href="single.html" class="dropdown-item">Área de cliente</a>
                            </div>
                        </div-->
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6">
                        <div class="about-content">
                            <div class="section-header">
                                <p>Nosotros</p>
                                <h2>Trabajando desde 2022</h2>
                            </div>
                            <div class="about-text">
                                <p>
                                    Somos un Start Up creada con la finalidad de acelerar los procesos de
                                    ventas y pedidos de pequeños, medianos y grandes restaurantes.
                                    Asímismo facilita el manejo administrativo de las ventas diviendo el
                                    trabajo entre subusuarios creados por el restaurante mismo.
                                </p>
                                <p>
                                    En pocas palabras, en "Mozo en Línea" puedes ofrecer tus platos y
                                    recibir pedidos a través de un sistema eficaz y en tiempo real,
                                    modificar la disponibilidad de tus comidas y saber si la venta es
                                    en el mismo local o en una ubicación a delivery.
                                </p>
                                <a class="btn custom-btn" href="signup.html">Empezar</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row align-items-center">
                    <div class="col-md-4">
                        <div class="food-item">
                            ...
                            <h2>Restaurante</h2>
                            <p>
                                Entidad generada por la persona al momento de la inscripción
                                en Mozo en línea. Puede tener: logo, portada, contenedores,
                                platos, ventas, configuración personalizada de colores...
                            </p>
                            <a href="">Ver más</a>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="food-item">
                            ...
                            <h2>Trabajador</h2>
                            <p>
                                Encargados del funcionamiento correcto de un restaurante,
                                definen el stock, verfician el trafico de ventas, estadisticas
                                del restaurante, modifican datos mencionados en "Restaurante"...
                            </p>
                            <a href="">Ver más</a>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="food-item">
                            ...
                            <h2>Cliente</h2>
                            <p>
                                Puede realizar compras en los distintos restaurantes que figuran
                                en "Mozo en línea", asímismo puede ver su historial de compras y
                                recibir beneficios de las empresas según su concurrencia...
                            </p>
                            <a href="">Ver más</a>
                        </div>
                    </div>
        ...
        <div class="menu">
            <div class="container">
                <div class="section-header text-center">
                    ...
                    <h2>Ve nuestros platos cercanos</h2>
                </div>
                <div class="menu-tab">
                    <ul class="nav nav-pills justify-content-center">
                        <li class="nav-item">
                            <a class="nav-link active" data-toggle="pill" href="#burgers">Mas recomendados</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" data-toggle="pill" href="#snacks">Más económicos</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" data-toggle="pill" href="#beverages">Mejor calificación</a>
                        </li>
                    </ul>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6">
                        <div class="team-item">
                            <div class="team-img">
                                <img src="assets/img/male-avatar.svg" alt="Image">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="team-item">
                            <div class="team-img">
                                <img src="assets/img/female-avatar.svg" alt="Image">
                                <div class="team-social">
                                    <a href=""><i class="fab fa-twitter"></i></a>
                                    <a href=""><i class="fab fa-facebook-f"></i></a>
                                    <a href=""><i class="fab fa-linkedin-in"></i></a>
                ...
                <div class="owl-carousel testimonials-carousel">
                    <div class="testimonial-item">
                        <div class="testimonial-img">
                            <img src="assets/img/restaurant-logo.svg" alt="Image">
                        </div>
                        <p>
                            <div>
                            ...
                            <span style="font-size: small;">5 calificaciones</span>
                        </p>
                        <h2>Rambo Chicken</h2>
                        <h3>Av. Marginal N° 125</h3>
                    </div>
                    <div class="testimonial-item">
                        <div class="testimonial-img">
                            <img src="assets/img/restaurant-logo.svg" alt="Image">
        ...
        <div class="footer">
            ...
            <div class="copyright">
                <div class="container">
                    <p>Copyright &copy; <a href="#">Mozo en línea</a>, Todos los derechos reservados.</p>
                    <p>Diseñado por <a href="#">GK Business</a></p>
                </div>
            </div>
        </div>
        <!-- Footer End -->
