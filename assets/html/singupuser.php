...
<head>
  <meta charset="utf-8">
  <title>Mozo en línea | Registro usuario</title>
        ...
        <div class="card-body">
          ...
          <form>
            ...
            <div class="row">
              ...
              <div class="col-md-12">
                <div class="mb-1">
                  <label class="form-label label-form-login" for="email">Correo electrónico / usuario</label>
              ...
              <div class="col-md-12">
                <div class="mb-1">
                  <button id="init-session-shop" class="btn">Crear cuenta</button>
                </div>
              </div>
            </div>
