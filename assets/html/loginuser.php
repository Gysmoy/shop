          ...
          <form>
            ...
            <div class="row">
              ...
              <div id="contVer" class="col-md-12">
                <div class="mb-1">
                  <label class="form-label label-form-login" for="">Ingrese codigo de verificasion</label>
                  <input id="verCod" class="form-control" type="text" placeholder="00000000">
                </div>
              </div>
              <div class="label-form-login">
                <p>Ya tengo cuenta <a href="#">deseo iniciar cecion</a></p>
              </div>
              <div class="col-md-12">
                <div class="mb-1">
                  <button type="submit" class="btn init-session-shop">Iniciar sesíon</button>
                </div>
              </div>
            </div>
          </form>
