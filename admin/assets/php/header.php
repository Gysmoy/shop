<div class="navbar-brand-wrapper d-flex d-lg-none align-items-center justify-content-center">
    <a class="navbar-brand brand-logo-mini" href="home.php">M</a>
</div>
<div class="navbar-menu-wrapper flex-grow d-flex align-items-stretch">
    ...
    <li class="nav-item dropdown d-none d-lg-block">
        <a class="nav-link btn btn-success create-new-button" id="createbuttonDropdown" data-bs-toggle="dropdown" aria-expanded="false" href="#">+ Agregar administrador</a>
    ...
    <li class="nav-item dropdown">
        ...
        <div class="dropdown-divider"></div>
        <a class="dropdown-item preview-item" href="account.php">
            <div class="preview-thumbnail">
            <div class="preview-icon bg-dark rounded-circle">
        ...
        <div class="dropdown-divider"></div>
        <a class="dropdown-item preview-item" href="./login.php?logout=1">
            <div class="preview-thumbnail">
            <div class="preview-icon bg-dark rounded-circle">
