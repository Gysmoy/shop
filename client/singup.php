...
<body>
    ...
    <div class="col-md-6 grid-margin stretch-card">
      <div class="conenedor-form card p-2">
        <div class="card-body">
          ...
          <a href="../../index.php"><img class="logo" src="assets/img/shop.svg" alt="logo"></a>
          ...
          <div class="row">
            <div class="col-md-12 mb-1">
              <button type="text" id="init-session-facebook" class="btn init-session-btn"> <img
            ...
            <div class="col-md-12 mb-3">
              <button type="text" id="init-session-google" class="btn init-session-btn"> <img
                src="assets/img/google_icon-icons.svg" class=" icon-init-session" alt="icon google">
            ...
            <div id="message-shop-cont" class="col-md-12">
              <div class="mb-1">
                ...
                <div id="message-shop-cont-color" class="alert  d-flex align-items-center" role="alert">
                  <svg id="message-shop-svg" class="bi flex-shrink-0 me-2" width="24" height="24" role="img"
                    aria-label="Success:">
                    <use id="message-shop-use" xlink:href="#exclamation-triangle-fill" />
                  </svg>
                  <div id="message-shop">
  ...
  <div>
    ...
    <script src="assets/js/combos.js"></script>
